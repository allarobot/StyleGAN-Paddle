...
class TrainOptions():
    def __init__(self):
        ...
        parser.add_argument('--resume', type=str, default='train_result/models/latest.pp')
    ...
    def parse(self):
        self.opts.device = 'GPU' if paddle.fluid.is_compiled_with_cuda() else 'CPU'
...
class InferenceOptions():
    def __init__(self):
        parser = argparse.ArgumentParser()
        parser.add_argument('--resume', type=str, default='train_result/model/latest')
        parser.add_argument('--type', type=str, default='style')
